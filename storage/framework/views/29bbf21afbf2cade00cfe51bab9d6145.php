...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.item','data' => ['icon' => 'shield-check','badge' => ''.e($count).'','href' => route('manage_approval'),'current' => $currentRoute === 'manage_approval','wire:navigate' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'shield-check','badge' => ''.e($count).'','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('manage_approval')),'current' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currentRoute === 'manage_approval'),'wire:navigate' => true]); ?>
        <?php echo e(__('Student Approval')); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\Users\monro\Herd\shusseki\resources\views/livewire/management/manage-approval-badge.blade.php ENDPATH**/ ?>