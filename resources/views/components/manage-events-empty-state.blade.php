...
<div class="p-5 h-full mt-12 flex flex-col justify-center items-center text-center">
    ...
    <svg class="w-48 mx-auto mb-4" width="178" height="90" viewBox="0 0 178 90" fill="none"
        ...
        <defs>
            <filter id="manage-events-empty-state-theme" x="0" y="0" width="178" height="64" filterUnits="userSpaceOnUse"
    ...
    <div class="max-w-sm mx-auto">
        ...
        <p class="text-sm text-gray-600 dark:text-neutral-400 mb-4">
            ...
            for <span class="font-medium text-gray-900 dark:text-white">{{ $selectedMonth }}</span> in the <span class="font-medium text-gray-900 dark:text-white">{{ $selectedSchoolYear }}</span> academic year.
        </p>
