@props(['selectedMonth', 'selectedSchoolYear'])

{{-- Smaller empty state for dashboard "Events This Month" card --}}
<div class="flex flex-col items-center justify-center text-center py-8">
    {{-- Smaller version of the original SVG --}}
    <svg class="w-24 mx-auto mb-3" width="89" height="45" viewBox="0 0 178 90" fill="none"
        ...
        <rect x="59" y="51" width="92" height="6" rx="3" fill="currentColor"
            class="fill-gray-100 dark:fill-neutral-700/70" />
        <g filter="url(#dashboard-events-empty-state-theme)">
        ...
        <defs>
            <filter id="dashboard-events-empty-state-theme" x="0" y="0" width="178" height="64" filterUnits="userSpaceOnUse"
    ...
    <div class="max-w-xs mx-auto">
        ...
        {{-- Smaller call to action button --}}
        <flux:button variant="filled" href="{{ route('create_event') }}" icon="plus" wire:navigate size="xs" class="mx-auto">
            Create Event
        </flux:button>
    </div>
</div>
