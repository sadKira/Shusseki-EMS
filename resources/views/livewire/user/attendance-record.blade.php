<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 lg:py-10">
    ...
    <div class="max-lg:hidden flex items-center justify-between whitespace-nowrap">
        <flux:heading size="xl" class="font-bold">Attendance <span class="text-[var(--color-accent)]">Record</span></flux:heading>
        ...
        @foreach ($events as $event)
            ...
            <div 
                ...
                <div 
                    ...
                    class="relative min-h-45 md:min-h-17 lg:min-h-17 max-w-md sm:max-w-full overflow-hidden rounded-xl bg-zinc-950
