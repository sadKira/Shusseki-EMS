<div>
    ...
    <div class="max-lg:hidden flex items-center justify-between whitespace-nowrap">
        <flux:heading size="xl" class="font-bold">Academic Year <span class="text-[var(--color-accent)]">{{ $selectedSchoolYear }}</span></flux:heading>
        <div class="flex items-center gap-3 justify-between">
            <flux:button variant="filled" href="{{route('create_event')}}" icon="plus" wire:navigate>Create Event</flux:button>
