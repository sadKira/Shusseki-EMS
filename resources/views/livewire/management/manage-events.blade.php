<div class="h-full rounded-lg p-10 dark:bg-zinc-800">
    ...
    <div data-hs-layout-splitter='{
        ...
        <div class="flex min-h-screen dark:border-neutral-700" data-hs-layout-splitter-horizontal-group="">

            {{-- Left side --}}
            <div class="overflow-hidden h-full" data-hs-layout-splitter-item="60" style="flex: 60 1 0px;">
                <div class="flex flex-col items-center h-full text-gray-800 dark:text-neutral-200">
                    ...
                    <div class="bg-white rounded-lg shadow-2xs sm:flex h-48 overflow-hidden
                                ...
                                dark:hover:shadow-amber-400/20 dark:focus:shadow-amber-400/20">
            ...
            {{-- Right side --}}
            <div class="overflow-hidden h-full" data-hs-layout-splitter-item="30" style="flex: 30 1 0px;">
