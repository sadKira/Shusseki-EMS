    ...
    <div class="grid grid-cols-5 gap-3">
        ...
        <div class="flex flex-col col-span-3 gap-3 flex-grow">
            ...
            <div class="px-10 py-6 rounded-xl" wire:poll.30s.visible>
                ...
                {{-- Content --}}
                <div
                    class="h-60 xl:h-90 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-zinc-900 dark:[&::-webkit-scrollbar-thumb]:bg-zinc-700">
        ...
        <div class="flex flex-col col-span-2 gap-3">
            ...
            <div class="px-6 py-6 rounded-xl metallic-card-soft space-y-3" wire:poll.30s.visible>
                ...
                {{-- Content --}}
                <div
                    class="h-90 xl:h-125 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-zinc-900 dark:[&::-webkit-scrollbar-thumb]:bg-zinc-700">
                    <div class="flex flex-col gap-2 w-full">
